...
def toggle_reqd_for_reference_in_payment_order(reqd=False):
	frappe.db.set_value("DocField", {"parent": "Payment Order Reference", "fieldname": "reference_doctype"}, "reqd", reqd)
	frappe.db.set_value("DocField", {"parent": "Payment Order Reference", "fieldname": "reference_name"}, "reqd", reqd)
	frappe.db.set_value("DocField", {"parent": "Payment Order Reference", "fieldname": "amount"}, {"reqd": reqd, "read_only": reqd})